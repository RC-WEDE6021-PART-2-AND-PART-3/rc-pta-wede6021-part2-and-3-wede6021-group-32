...
<body>
    ...
    <div class="product-grid" id="productGrid">
        ...
        <div class="product-card" data-category="women">
            ...
            <div class="product-info">
                ...
                <button class="add-to-cart" onclick="addToCart('Vintage Floral Maxi Dress', 42)">Add to Cart 🛒</button>
            </div>
        </div>

        <!-- Item 2: Wool Cashmere Sweater -->
        <div class="product-card" data-category="women">
            ...
            <div class="product-info">
                ...
                <button class="add-to-cart" onclick="addToCart('Cashmere Blend Sweater', 52)">Add to Cart 🛒</button>
            </div>
        </div>

        <!-- Item 3: High-Waisted Jeans -->
        <div class="product-card" data-category="women">
            ...
            <div class="product-info">
                ...
                <button class="add-to-cart" onclick="addToCart('Vintage High-Waisted Jeans', 38)">Add to Cart 🛒</button>
            </div>
        </div>

        <!-- Item 4: Leather Jacket -->
        <div class="product-card" data-category="women">
            ...
            <div class="product-info">
                ...
                <button class="add-to-cart" onclick="addToCart('Genuine Leather Moto Jacket', 89)">Add to Cart 🛒</button>
            </div>
        </div>
        ...
        <div class="product-card" data-category="men">
            ...
            <div class="product-info">
                ...
                <button class="add-to-cart" onclick="addToCart('Vintage Denim Trucker Jacket', 45)">Add to Cart 🛒</button>
            </div>
        </div>
        ...
        <div class="product-card" data-category="men">
            ...
            <div class="product-info">
                ...
                <button class="add-to-cart" onclick="addToCart('Classic Oxford Button-Down', 28)">Add to Cart 🛒</button>
            </div>
        </div>
        ...
        <div class="product-card" data-category="men">
            ...
            <div class="product-info">
                ...
                <button class="add-to-cart" onclick="addToCart('Slim Fit Chino Pants', 32)">Add to Cart 🛒</button>
            </div>
        </div>
        ...
        <div class="product-card" data-category="men">
            ...
            <div class="product-info">
                ...
                <button class="add-to-cart" onclick="addToCart('Wool Peacoat', 75)">Add to Cart 🛒</button>
            </div>
        </div>
        ...
        <div class="product-card" data-category="accessories">
            ...
            <div class="product-info">
                ...
                <button class="add-to-cart" onclick="addToCart('Genuine Leather Shoulder Bag', 48)">Add to Cart 🛒</button>
            </div>
        </div>

        <!-- Item 10: Sunglasses -->
        <div class="product-card" data-category="accessories" data-category="sale">
            <div style="position: relative;">
            ...
            <div class="product-info">
                ...
                <button class="add-to-cart" onclick="addToCart('Retro Round Sunglasses', 18)">Add to Cart 🛒</button>
            </div>
        </div>

        <!-- Item 11: Leather Boots -->
        <div class="product-card" data-category="accessories">
            ...
            <div class="product-info">
                ...
                <button class="add-to-cart" onclick="addToCart('Leather Chelsea Boots', 65)">Add to Cart 🛒</button>
            </div>
        </div>
        ...
        <div class="product-card" data-category="accessories" data-category="sale">
            ...
            <div class="product-info">
                ...
                <button class="add-to-cart" onclick="addToCart('Cashmere Blend Scarf', 15)">Add to Cart 🛒</button>
            </div>
        </div>
    </div>
    ...
    <script>
        ...
        function addToCart(itemName, price) {
            ...
            notification.style.background = '#1d3c34';
            ...
            notification.innerHTML = `✅ Added "${itemName}" to cart! ($${price})`;
            ...
            // Update cart count in console (for demo)
            console.log(`Cart (${cartCount} items):`, cartItems);
        }
        ...
        console.log('🛍️ Welcome to Past Times Shop! Click "Add to Cart" on any item.');
    </script>
</body>
</html>